...
public class Version {
    public static final int VERSION = 322; // Increment by 1 for new version. Updated for 4.6.0. (plus held item threshold tweak)
    public static final String VERSION_STRING = "4.6.1-xen-thresholdHeldItems-0.2.0";
