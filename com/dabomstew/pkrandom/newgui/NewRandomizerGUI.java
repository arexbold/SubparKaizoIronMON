...
public class NewRandomizerGUI {
    ...
    private JSpinner tpTrainerHeldItemLevelThreshold;
    ...
    private void initExplicit() {
        ...
        SpinnerModel trainerHeldItemLevelThresholdModel = new SpinnerNumberModel(
                1,
                1,
                100,
                1
        ...
        tpTrainerHeldItemLevelThreshold.setModel(trainerHeldItemLevelThresholdModel);
    ...
    private void restoreStateFromSettings(Settings settings) {
        ...
        tpTrainerHeldItemLevelThreshold.setValue(settings.getTrainerHeldItemsPokemonLevelThreshold() > 0 ? settings.getTrainerHeldItemsPokemonLevelThreshold() : 1);
    ...
    private Settings createSettingsFromState(CustomNamesSet customNames) {
        ...
        settings.setTrainerHeldItemsPokemonLevelThreshold((int)tpTrainerHeldItemLevelThreshold.getValue());
    ...
    private void initialState() {
        ...
        tpTrainerHeldItemLevelThreshold.setVisible(true);
        tpTrainerHeldItemLevelThreshold.setEnabled(true);
        tpTrainerHeldItemLevelThreshold.setValue(1);
    ...
    private void romLoaded() {
        ...
        try {
            ...
            tpHighestLevelGetsItemCheckBox.setEnabled(false);
            tpTrainerHeldItemLevelThreshold.setVisible(trainersHeldItemSupport);
    ...
    private void enableOrDisableSubControls() {
        ...
        if (tpBossTrainersItemsCheckBox.isSelected() || tpImportantTrainersItemsCheckBox.isSelected() ||
            ...
            tpSensibleItemsCheckBox.setEnabled(false);
            tpHighestLevelGetsItemCheckBox.setEnabled(false);
            tpTrainerHeldItemLevelThreshold.setEnabled(false);
        }
