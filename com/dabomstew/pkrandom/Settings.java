...
public class Settings {
    ...
    private int trainerHeldItemsPokemonLevelThreshold = 0;
    ...
    public String toString() {
        ...
        // 51 level threshold for trainer held items
        out.write(trainerHeldItemsPokemonLevelThreshold);
    ...
    public static Settings fromString(String settingsString) throws UnsupportedEncodingException, IllegalArgumentException {
        ...
        settings.setTrainerHeldItemsPokemonLevelThreshold(data[51]);
    ...
    public int getTrainerHeldItemsPokemonLevelThreshold() {
        return trainerHeldItemsPokemonLevelThreshold;
    }

    public void setTrainerHeldItemsPokemonLevelThreshold(int levelThreshold) {
        this.trainerHeldItemsPokemonLevelThreshold = levelThreshold;
    }
